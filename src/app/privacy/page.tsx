      ...
      <div className="max-w-2xl mx-auto bg-card rounded-lg shadow-lg p-8 border border-muted">
        ...
        <div className="space-y-4 text-muted-foreground text-sm">
          ...
          <ul className="list-disc pl-5">
            <li><b>認証情報</b>: Googleログイン時に提供されるユーザーID、メールアドレス、プロフィール画像。これらはユーザーの識別とデータ保存のためにのみ使用されます。</li>
            <li><b>利用データ</b>: タイマーのタップ履歴、設定情報。</li>
            <li><b>通知トークン</b>: プッシュ通知を送信するために必要なFCMトークン。</li>
          </ul>
          ...
          <p>当方は、法令に基づく場合を除き、あらかじめユーザーの同意を得ることなく第三者に個人情報を提供することはありません。ただし、本サービスの基盤としてGoogle Firebaseを使用しており、データはGoogleのサーバー上で管理されます。</p>
